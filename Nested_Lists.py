...
n = int(raw_input())
studentsList = [[raw_input(), float(raw_input())] for _ in range(n)]
second_lowest = sorted(list(set([grade for name, grade in studentsList])))[1]
print('\n'.join([a for a,b in sorted(studentsList) if b == second_lowest]))
